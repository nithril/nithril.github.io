---
layout: post
title:  "Continuous Promise<Release>"
...
Continuous Release process allows an artifact to be continously **releasable** and be promoted to the upper environment. 
  
The topic has been covered by a large amount of articles, so why this new one? Continuous release of an Application with a big A (eg. executable jar, war)
   is indeed well covered but not the continuous release of the Dependency (eg. jar library) of the Application.
